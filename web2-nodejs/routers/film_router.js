import {associarFilmeDiretor, createFilm, deletaFilm, editFilm, listFilm} from "../controllers/film_controller.js";
...
film_router.post('/:id/director', associarFilmeDiretor);
